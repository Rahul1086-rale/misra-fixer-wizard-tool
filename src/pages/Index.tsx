      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            AI-powered MISRA C++ violation fixing tool using Gemini AI. Upload your code, analyze violations, and get intelligent fixes automatically.
          </p>
          <Link to="/chat">
        ...
        >
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>
                Powered by Google's Gemini AI for intelligent code analysis and fixing
              </CardDescription>
            </CardHeader>
          </Card>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Receive intelligent code fixes from Gemini AI and apply them to your code
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <Card className="bg-gradient-to-r from-primary/10 to-secondary/10 border-primary/20">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6">
                Start using the AI-powered MISRA Fix Copilot to make your C++ code compliant and safer.
              </p>
              <Link to="/chat">
                <Button size="lg">
                  Launch Copilot <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
            </CardContent>
          </Card>
